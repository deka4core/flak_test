...
def load_photo():
    if request.method == 'GET':
                                    ...
                                    <div>
                                        <form class="login_form" method="post" enctype="multipart/form-data">
                                               <div class="form-group">
                                                ...
                                                <img src="{url_for('static', filename='img/loaded_image.png')}"
        ...
        with open(url_for('static', filename='img/loaded_image.png')[1:], 'wb') as image:
            image.write(f.read())
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img src="{url_for('static', filename='img/mars2.png')}" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="{url_for('static', filename='img/mars3.png')}" class="d-block w-100" alt="...">
            </div>
        </div>
    </div>
